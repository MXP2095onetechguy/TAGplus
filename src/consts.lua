local CONSTS = {} -- Export table of constants
...
-- Load it all
CONSTS.NORM_MAX_HELTH = NORM_MAX_HELTH
CONSTS.TURB_MAX_HELTH = TURB_MAX_HELTH
CONSTS.NORM_BGM_PITCH = NORM_BGM_PITCH
CONSTS.TURB_BGM_PITCH = TURB_BGM_PITCH
